  ...
  products: [
    {
      ...
      category: "outerwear",
      image: "assets/editorial-model.jpg",
      price: "EUR 680",
      delivery: "ready",
      color: { en: "Black", zh: "黑色" },
      availability: { en: "In stock", zh: "现货" },
      shipping: { en: "2-4 business days", zh: "2-4 个工作日" },
      sizes: ["XS", "S", "M", "L"],
      defaultSize: "S",
      name: { en: "Archive Leather Trench", zh: "Archive Leather Trench" },
      cardCategory: { en: "Outerwear", zh: "外套" },
      cardCaption: {
    ...
    },
    {
      ...
      category: "outerwear",
      image: "assets/poster-reference.jpg",
      price: "EUR 520",
      delivery: "ready",
      color: { en: "Black", zh: "黑色" },
      availability: { en: "In stock", zh: "现货" },
    ...
    },
    {
      ...
      category: "set",
      image: "assets/hero-reference.jpg",
      price: "EUR 430",
      delivery: "ready",
      color: { en: "Black", zh: "黑色" },
      availability: { en: "Low stock", zh: "库存很少" },
      shipping: { en: "2-4 business days", zh: "2-4 个工作日" },
      sizes: ["S", "M"],
      defaultSize: "S",
      name: { en: "Black Studio Set", zh: "Black Studio Set" },
      cardCategory: { en: "Set", zh: "套装" },
      cardCaption: {
    ...
    },
    {
      ...
      category: "layering",
      image: "assets/motion-reference.jpg",
      price: "EUR 210",
      delivery: "made",
      color: { en: "Black", zh: "黑色" },
      availability: { en: "Available to source", zh: "可代寻" },
      shipping: { en: "5-8 business days", zh: "5-8 个工作日" },
      sizes: ["S", "M", "L"],
      defaultSize: "M",
      name: { en: "After Dark Shell Top", zh: "After Dark Shell Top" },
      cardCategory: { en: "Layering", zh: "叠穿" },
      cardCaption: {
